...
class Questionnaires extends Component {
  ...
  sendQuestionnaires(user_no_){
    ...
    fetch(`${API_URL}/api/questionnaires_behaviour/` + user_no_, {
       method: 'POST',
       headers: {
  ...
  render_quest(quest_No) {
    ...
    let IQIMAGES = {questions: [
          { type: "html",
            name: "info",
            html: "<table><body></br></br></br></br><img src='/images/quest/mx45_q.png' width='230px'/></br></br></br> </td><img src='/images/quest/mx45_a.png' width='460px'/></body></table>"},
          ...
          { type: "html",
            name: "info",
            html: "<table><body></br></br></br></br><img src='/images/quest/mx46_q.png' width='230px'/></br></br></br> </td><img src='/images/quest/mx46_a.png' width='460px'/></body></table>"},
          ...
          { type: "html",
            name: "info",
            html: "<table><body></br></br></br></br><img src='/images/quest/mx47_q.png' width='230px'/></br></br></br> </td><img src='/images/quest/mx47_a.png' width='460px'/></body></table>"},
          ...
          { type: "html",
            name: "info",
            html: "<table><body></br></br></br></br><img src='/images/quest/mx55_q.png' width='230px'/></br></br></br> </td><img src='/images/quest/mx55_a.png' width='460px'/></body></table>"},
          ...
          { type: "html",
            name: "info",
            html: "<table><body></br></br></br></br><img src='/images/quest/rsd3_q.png' width='550px'/></body></table>"},
          ...
          { type: "html",
            name: "info",
            html: "<table><body></br></br></br></br><img src='/images/quest/rsd4_q.png' width='550px'/></body></table>"},
          ...
          { type: "html",
            name: "info",
            html: "<table><body></br></br></br></br><img src='/images/quest/rsd6_q.png' width='550px'/></body></table>"},
          ...
          { type: "html",
            name: "info",
            html: "<table><body></br></br></br></br><img src='/images/quest/rsd8_q.png' width='550px'/></body></table>"},
